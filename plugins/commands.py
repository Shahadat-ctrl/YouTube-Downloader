	...
	await cmd.reply_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				...
				[
					InlineKeyboardButton("👨🏼‍💻Developer", url='https://t.me/developer_x_app'),
					InlineKeyboardButton("⚙️Update Channel", url="https://t.me/setting")
				]
			]
		)
	)
	...
	await cmd.reply_text(
		...
		reply_markup=InlineKeyboardMarkup(
			[
				...
				[
					InlineKeyboardButton("👨🏼‍💻Developer", url='https://t.me/developer_x_app'),
					InlineKeyboardButton("⚙️Update Channel", url="https://t.me/developer_x_app")
				]
			]
		)
	)
